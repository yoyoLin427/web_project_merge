<template>
    <div>
        <div class="logobar">
            ...
            <b-row>
                <b-col>
                    <img v-if="showBackArrow" @click="goOff()" class="arrowiconimg" src="@/assets/svg/keyboard_arrow_left.svg">
                </b-col>
                <b-col class="text-center">
                    <div v-if="showText" class="text">{{navText}}</div>
                    <!--暫時link到空頁面-->
                    <router-link v-else to="/temp">
                        <img class="logoimg" src="@/assets/svg/logo.svg">
                    </router-link> 
                </b-col>
                <b-col class="imgright">
                    <!--暫時link到空頁面-->
                    <router-link v-if="showRecord" to="/temp">
                        <img  class="usericonimg" src="@/assets/svg/recored.svg">
                    </router-link> 
                    <!--暫時link到空頁面-->
                    <router-link v-if="showUser" to="/temp">
